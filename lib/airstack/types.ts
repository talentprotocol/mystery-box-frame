...
export type PoaPsOwnedQuery = { Poaps: { Poap: Array<{ mintOrder: number | null, mintHash: string | null, poapEvent: { isVirtualEvent: boolean | null } | null, owner: { addresses: Array<any> | null } }> | null, pageInfo: { nextCursor: string, prevCursor: string } | null } | null };
